...
import { LoginUserEmailPassword } from '~/services/auth/login/login_email_password';
import { LoginGoogle } from './auth/login/login_google';
...
const services = {
  auth: {
    ...
    login: {
      emailAndPassword: LoginUserEmailPassword, 
      google: LoginGoogle
    },
    jwt: {
